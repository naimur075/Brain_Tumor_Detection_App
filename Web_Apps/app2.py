...
def train_neural_network(X_train, y_train, num_epochs, learning_rate, model_count):
    ...
    model.save_model("Real Time Model", model_count)
        ...
        if uploaded_files is not None and len(uploaded_files) > 0:
            ...
            if start_training:
                ...
                for uploaded_file in uploaded_files:
                    ...
                    label = 0 if "no" in uploaded_file.name else 1
                ...
                model_count = len([f for f in os.listdir("Real Time Model") if f.startswith("trained_model_")]) + 1
                model = train_neural_network(X_train, y_train, num_epochs, learning_rate, model_count)
